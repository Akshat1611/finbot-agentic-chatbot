...
st.write(
    "Upload expense data, enter your monthly budget, and receive "
...
if uploaded_file and budget > 0:
    ...
    ax2.bar(categories, actual, label="Actual")
    ax2.bar(categories, limits, alpha=0.6, label="Recommended")
    ax2.legend()
